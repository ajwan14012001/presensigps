...
@section('content')
                                            ...
                                            <div class="col-10">
                                                <div class="form-group">
                                                    <input type="text" name="nama_dept" id="nama_dept"
                                                        class="form-control" placeholder="Kelas / Jurusan"
                            ...
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="" id="kode_dept" class="form-control"
                                        placeholder="Kelas" name="kode_dept">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="" id="nama_dept" class="form-control"
                                        name="nama_dept" placeholder="Jurusan">
                                </div>
                            </div>
                        </div>
                        <div class="row mt-2">
    ...
    <div class="modal modal-blur fade" id="modal-editdepartemen" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Data Kelas & Jurusan</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
    ...
    <script>
        $(function() {
            ...
            $('.edit').click(function() {
                ...
                //$('#loadeditform').load('departemen/edit/' + kode_dept);
            });
